namespace Api.Models
{
    ...
    public class ItemsFilter : IMapWith<ListAllItemsQueryFilter>
    {
        ...
        [FromQuery(Name = "getLiveItems")] public bool? GetLiveItems { get; set; }

        [FromQuery(Name = "startTime")] public DateTime? StartTime { get; set; }

        [FromQuery(Name = "endTime")] public DateTime? EndTime { get; set; }

        [FromQuery(Name = "minimumPicturesCount")]
        [Range(1, int.MaxValue)]
        public int? MinimumPicturesCount { get; set; }

        [FromQuery(Name = "subCategoryId")] public Guid SubCategoryId { get; set; }
    }
}