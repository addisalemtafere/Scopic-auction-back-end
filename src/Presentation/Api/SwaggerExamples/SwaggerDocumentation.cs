namespace Api.SwaggerExamples
{
    public static class SwaggerDocumentation
    {
        ...
        public static class PictureConstants
        {
            ...
            public const string SuccessfulGetPictureDetailsRequestDescriptionMessage =
                "Pictures were retrieved successfully and returned";
        }
        ...
        public static class IdentityConstants
        {
            ...
            public const string SuccessfulLoginRequestDescriptionMessage =
                "Indicates that everything went ok and returns jwt token";
            ...
            public const string BadRequestOnConfirmEmailMessage =
                "Indicates that the provided code was invalid and email is not confirmed";
            ...
            public const string BadRequestOnTokenRefreshDescriptionMessage =
        ...
        public static class AdminConstants
        {
            ...
            public const string SuccessfulPostRequestDescriptionMessage =
                "Indicates that user is successfully added to the given role";

            public const string BadRequestDescriptionMessage = "Indicates that either the role or user data is invalid";

            public const string SuccessfulDeleteRequestDescriptionMessage =
                "Indicates that user is no longer administrator";
        }
    }
}